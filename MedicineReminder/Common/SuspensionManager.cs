    ...
    internal sealed class SuspensionManager
    {
        ...
        public static async Task SaveAsync()
        {
            ...
            serializer.WriteObject(sessionData, _sessionState);
                ...
                // GetId an output stream for the SessionState file and write the state asynchronously
        ...
        public static async Task RestoreAsync()
        {
            ...
            try
            {
                // GetId the input stream for the SessionState file
        ...
        {
            // RemoveId session state and remove the frame from the list of frames whose navigation
